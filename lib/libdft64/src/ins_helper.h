...
#define I2R_CALL(fn, dst, imme)                                                \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                IARG_THREAD_ID, IARG_UINT32, REG_INDX(dst), IARG_UINT32, imme, \
                IARG_END);

#define I2M_CALL(fn, imme)                                                     \
  INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)fn, IARG_FAST_ANALYSIS_CALL,     \
                IARG_THREAD_ID, IARG_MEMORYWRITE_EA, IARG_UINT32, imme,        \
                IARG_END);


#define INS_MemoryWriteSize(ins) \
